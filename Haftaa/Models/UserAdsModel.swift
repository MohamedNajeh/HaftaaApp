...
//
//    enum CodingKeys: String, CodingKey {
//        case id, users, since, comment, childes
...
//    let detail: String
//    let video: String
//    let videoID, phone, commentAllow: String
//    let price: Int
//    let edit: Bool
//    let image: String
//    let images: [Image]
//    let comments: [Comment]
//    let countViews: Int
//    let rate, since, lat, lng: String
//    let distance, typeAds: String
//    let mayReport, allreport: [JSONAny]
//    let reviewAds: [Rate]
//    let favorit: Int
//
//    enum CodingKeys: String, CodingKey {
//        case id, title, adsType, user, city, country, category, detail, video
